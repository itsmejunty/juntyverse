  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-white via-purple-50/30 to-violet-50/50">
      ...
      <section className="py-20 section-gradient relative overflow-hidden">
        {/* Enhanced floating decoration elements with more advanced animations */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {projects.map((project, index) => (
              <div key={project.title} className="animate-fade-in hover-lift transition-all duration-500 group hover:scale-105" style={{ animationDelay: `${index * 0.2}s` }}>
      ...
      {/* Enhanced CTA Section with purple theme and advanced animations */}
      <section className="py-20 bg-gradient-to-br from-purple-50/50 via-white to-violet-50/30 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto glass-effect p-12 rounded-3xl shadow-2xl border border-purple-200/50 hover:shadow-3xl hover:shadow-purple-200/30 transition-all duration-500 hover:scale-105 group purple-glow hover:border-purple-300/70">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-10 animate-fade-in leading-relaxed hover:text-muted-foreground/80 transition-colors duration-300" style={{ animationDelay: '0.2s' }}>
              I'm currently available for freelance work and full-time positions. 
              If you're looking for a developer who is passionate about creating elegant solutions, let's talk!
            </p>
            <div className="animate-fade-in" style={{ animationDelay: '0.4s' }}>
              <Link to="/contact">
                <Button size="lg" className="bg-gradient-to-r from-purple-600 to-violet-600 hover:from-purple-700 hover:to-violet-700 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-110 hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden px-10 py-7">
